...
public class Land : MonoBehaviour, ITimeTracker
{
    ...
    public void LoadLandData(LandStatus landStatusToSwitch, GameTimeStamp lastWatered, FarmObstacleStatus obstacleStatusToSwitch)
    {
        ...
        if (obstacleObject != null) obstacleObject.transform.position = new Vector3(transform.position.x, 0.5f, transform.position.z);
    ...
    public CropBehaviour SpawnCrop()
    {
        ...
        cropObject.transform.position = new Vector3(transform.position.x, 0.5f, transform.position.z);
